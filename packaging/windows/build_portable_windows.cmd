@echo off
setlocal
rem Usage: build_portable_windows.cmd <qt-root> <cmake-platform> <package-suffix>
...
set "WORK_ROOT=%TEMP%\xvolkolak_%PACKAGE_SUFFIX%"
set "BUILD_DIR=%WORK_ROOT%\build"
set "QT_PREFIX_PATH=%QT_ROOT%"
set "APP_NAME=xvolkolak.exe"
set "PACKAGE_BASENAME=xvolkolak_%PACKAGE_SUFFIX%_portable"
